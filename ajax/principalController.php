	...
	static function manage_requires($rut_absolut){
		...
		if ($dir=='mailer') 
		{
			...
			if ($dir['nombre'] != null != null && $dir['correo'] != null && $dir['telefono'] != null && $dir['mensaje'] != null) {
				...
				$dat_admin = array('emiliano0662@gmail.com','IPSA Ingenieria Ambiental');
				
				$dat_client = array($dir['correo'],$dir['nombre']);

				principal_send($dat_client,$dat_admin,'Consulta www.ipsaingenieriaambiental.com',$data,__DIR__.'/mailer/plantilla-admin.php');
				principal_send($dat_admin,$dat_client,'IPSA Ingenieria Ambiental',$data,__DIR__.'/mailer/plantilla.php');
